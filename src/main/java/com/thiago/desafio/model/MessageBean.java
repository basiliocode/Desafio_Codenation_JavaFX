package com.thiago.desafio.model;

public class MessageBean {

    public static final String CONFIG_FILE = "answer.json";
    ...
    public String getDecifrado() { return decifrado; }

    public void setDecifrado(String decifrado) { this.decifrado = decifrado; }
